...
public class SideDishes extends AppCompatActivity {
    CheckBox c1,c2,c3,c4,c5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_side_dishes);
        c1 = (CheckBox) findViewById(R.id.box16);
        c2 = (CheckBox) findViewById(R.id.box17);
        c3 = (CheckBox) findViewById(R.id.box18);
        c4 = (CheckBox) findViewById(R.id.box19);
        c5 = (CheckBox) findViewById(R.id.box20);
    }
    @Override
    ...
    public void add() {
        ...
        if(c2.isChecked())
        {
            arr.add("Spectra Fries / ");
            arr2.add(24.90);

        }else
        {
            arr.remove("Spectra Fries / ");
            arr2.remove(24.90);
        ...
        if(c3.isChecked())
        {
            arr.add("Gratain Potatoes / ");
            arr2.add(24.80);
        }else
        {
            arr.remove("Gratain Potatoes / ");
            arr2.remove(24.80);
        ...
        {
            arr2.add(24.70);
            arr.add("Corn on the Cob / ");

        }else
        {
            arr.remove("Corn on the Cob / ");
            arr2.remove(24.70);
        }
