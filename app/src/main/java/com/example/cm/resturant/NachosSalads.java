...
public class NachosSalads extends AppCompatActivity {

    CheckBox c1,c2,c3,c4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nachos_salads);
        c1 = (CheckBox) findViewById(R.id.box26);
        c2 = (CheckBox) findViewById(R.id.box27);
        c3 = (CheckBox) findViewById(R.id.box28);
        c4 = (CheckBox) findViewById(R.id.box29);
    ...
    public void add() {
        ...
        {
            arr2.add(59.99);
            arr.add("Nachos Cold Cuts Salad / ");


        }else
        {
            arr.remove("Nachos Cold Cuts Salad / ");
            arr2.remove(59.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Nachos Chicken Salad / ");
            arr2.add(60.99);

        }else
        {
            arr.remove("Nachos Chicken Salad / ");
            arr2.remove(60.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Nachos Smoked Salmon Salad / ");
            arr2.add(89.99);
        }else
        {
            arr.remove("Nachos Smoked Salmon Salad / ");
            arr2.remove(89.99);
        ...
        {
            arr2.add(69.99);
            arr.add("Nachos Veal Salad / ");

        }else
        {
            arr.remove("Nachos Veal Salad / ");
            arr2.remove(69.99);
        }
