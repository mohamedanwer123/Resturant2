...
public class Salads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = (CheckBox) findViewById(R.id.box21);
        c2 = (CheckBox) findViewById(R.id.box22);
        c3 = (CheckBox) findViewById(R.id.box23);
        c4 = (CheckBox) findViewById(R.id.box24);
        c5 = (CheckBox) findViewById(R.id.box25);
    }
    ...
    public void add() {
        ...
        {
            arr2.add(59.99);
            arr.add("Nachos Chicken Caesar / ");


        }else
        {
            arr.remove("Nachos Chicken Caesar / ");
            arr2.remove(59.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Country Fried Chicken Caesar / ");
            arr2.add(52.99);

        }else
        {
            arr.remove("Country Fried Chicken Caesar / ");
            arr2.remove(52.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Smoked Chicken Caesar / ");
            arr2.add(53.99);
        }else
        {
            arr.remove("Smoked Chicken Caesar / ");
            arr2.remove(53.99);
        ...
        {
            arr2.add(74.99);
            arr.add("Grilled Shrimp Caesar / ");

        }else
        {
            arr.remove("Grilled Shrimp Caesar / ");
            arr2.remove(74.99);
        }

        if(c5.isChecked())
        {
            arr.add("Spectra Sea Food Caesar / ");
            arr2.add(75.99);
        }else
        {
            arr.remove("Spectra Sea Food Caesar / ");
            arr2.remove(75.99);
