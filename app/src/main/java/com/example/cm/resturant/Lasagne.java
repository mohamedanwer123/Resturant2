...
public class Lasagne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = (CheckBox) findViewById(R.id.box36);
        c2 = (CheckBox) findViewById(R.id.box37);
        c3 = (CheckBox) findViewById(R.id.box38);
        c4 = (CheckBox) findViewById(R.id.box39);
        c5 = (CheckBox) findViewById(R.id.box40);
    }
    ...
    public void add() {
        ...
        {
            arr2.add(59.99);
            arr.add("Chicken Lasagne / ");


        }else
        {
            arr.remove("Chicken Lasagne / ");
            arr2.remove(59.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Calamari Lasagne / ");
            arr2.add(64.99);

        }else
        {
            arr.remove("Calamari Lasagne / ");
            arr2.remove(64.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Mexican Chicken Lasagne / ");
            arr2.add(58.99);
        }else
        {
            arr.remove("Mexican Chicken Lasagne / ");
            arr2.remove(58.99);
        ...
        {
            arr2.add(60.99);
            arr.add("Minced Beef Lasagnep / ");

        }else
        {
            arr.remove("Minced Beef Lasagne / ");
            arr2.remove(60.99);
        }

        if(c5.isChecked())
        {
            arr.add("Veggie Lasagne / ");
            arr2.add(49.99);
        }else
        {
            arr.remove("Veggie Lasagne / ");
            arr2.remove(49.99);
