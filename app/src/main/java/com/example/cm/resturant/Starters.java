...
public class Starters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = (CheckBox) findViewById(R.id.box6);
        c2 = (CheckBox) findViewById(R.id.box7);
        c3 = (CheckBox) findViewById(R.id.box8);
        c4 = (CheckBox) findViewById(R.id.box9);
        c5 = (CheckBox) findViewById(R.id.box10);
    }
    ...
    public void add() {
        ...
        {
            arr2.add(69.99);
            arr.add("The Jumbo Combo / ");


        }else
        {
            arr.remove("The Jumbo Combo / ");
            arr2.remove(69.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Chicken Strips / ");
            arr2.add(36.99);

        }else
        {
            arr.remove("Chicken Strips / ");
            arr2.remove(36.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Fried Mozzarella ");
            arr2.add(53.99);
        }else
        {
            arr.remove("Fried Mozzarella / ");
            arr2.remove(53.99);
        ...
        {
            arr2.add(49.99);
            arr.add("Triple Cheese Nachos / ");

        }else
        {
            arr.remove("Triple Cheese Nachos / ");
            arr2.remove(49.99);
        }

        if(c5.isChecked())
        {
            arr.add("Fried Mushroom / ");
            arr2.add(29.99);
        }else
        {
            arr.remove("Fried Mushroom / ");
            arr2.remove(29.99);
