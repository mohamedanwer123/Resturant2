...
public class Pasta extends AppCompatActivity {
    ...
    public void add() {
        ...
        {
            arr2.add(49.99);
            arr.add("Grilled Chicken Penne / ");


        }else
        {
            arr.remove("Grilled Chicken Penne / ");
            arr2.remove(49.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Grilled Chicken Fettuccine / ");
            arr2.add(48.99);

        }else
        {
            arr.remove("Grilled Chicken Fettuccine / ");
            arr2.remove(48.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Grilled Chicken Cheese Pasta / ");
            arr2.add(59.99);
        }else
        {
            arr.remove("Grilled Chicken Cheese Pasta / ");
            arr2.remove(59.99);
        ...
        {
            arr2.add(47.99);
            arr.add("Grilled Chicken Penne Basil Sauce / ");

        }else
        {
            arr.remove("Grilled Chicken Penne Basil Sauce / ");
            arr2.remove(47.99);
        }

        if(c5.isChecked())
        {
            arr.add("Spaghetti Eggplant / ");
            arr2.add(39.99);
        }else
        {
            arr.remove("Spaghetti Eggplant / ");
            arr2.remove(39.99);
