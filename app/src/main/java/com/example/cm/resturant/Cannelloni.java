...
public class Cannelloni extends AppCompatActivity {
    CheckBox c1,c2,c3,c4,c5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cannelloni);
        c1 = (CheckBox) findViewById(R.id.box31);
        c2 = (CheckBox) findViewById(R.id.box32);
        c3 = (CheckBox) findViewById(R.id.box33);
        c4 = (CheckBox) findViewById(R.id.box34);
        c5 = (CheckBox) findViewById(R.id.box35);
    }
    @Override
