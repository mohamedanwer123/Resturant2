...
public class soup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = (CheckBox) findViewById(R.id.box1);
        c2 = (CheckBox) findViewById(R.id.box2);
        c3 = (CheckBox) findViewById(R.id.box3);
        c4 = (CheckBox) findViewById(R.id.box4);
        c5 = (CheckBox) findViewById(R.id.box5);
    }
    ...
    public void add() {
        ...
        {
            arr2.add(25.99);
            arr.add("Cream of Sweet Corn Soup / ");


        }else
        {
            arr.remove("Cream of Sweet Corn Soup / ");
            arr2.remove(25.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Cream of Chicken & Mushroom Soup / ");
           arr2.add(24.99);

        }else
        {
            arr.remove("Cream of Chicken & Mushroom Soup / ");
            arr2.remove(24.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Cream of Mushroom Soup / ");
            arr2.add(23.99);
        }else
        {
            arr.remove("Cream of Mushroom Soup / ");
            arr2.remove(23.99);
        ...
        {
            arr2.add(22.99);
            arr.add("Tomato Lentil Soup / ");

        }else
        {
            arr.remove("Tomato Lentil Soup / ");
            arr2.remove(22.99);
        }

        if(c5.isChecked())
        {
            arr.add("Cream of Tomato Soup / ");
            arr2.add(21.99);
        }else
        {
            arr.remove("Cream of Tomato Soup / ");
      arr2.remove(21.99);
