...
public class ChickenChineseNoodles extends AppCompatActivity {
    CheckBox c1,c2,c3,c4,c5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chicken_chinese_noodles);
        c1 = (CheckBox) findViewById(R.id.box46);
        c2 = (CheckBox) findViewById(R.id.box47);
        c3 = (CheckBox) findViewById(R.id.box48);
        c4 = (CheckBox) findViewById(R.id.box49);
        c5 = (CheckBox) findViewById(R.id.box50);
    }
    ...
    public void add() {
        ...
        {
            arr2.add(54.99);
            arr.add("Chicken Chinese Noodles / ");


        }else
        {
            arr.remove("Chicken Chinese Noodles / ");
            arr2.remove(54.99);
        ...
        if(c2.isChecked())
        {
            arr.add("Veal Chinese Noodles / ");
            arr2.add(74.99);

        }else
        {
            arr.remove("Veal Chinese Noodles / ");
            arr2.remove(74.99);
        ...
        if(c3.isChecked())
        {
            arr.add("Beef Chinese Noodles / ");
            arr2.add(73.99);
        }else
        {
            arr.remove("Beef Chinese Noodles / ");
            arr2.remove(73.99);
        ...
        {
            arr2.add(49.99);
            arr.add("Veggie Chinese Noodles / ");

        }else
        {
            arr.remove("Veggie Chinese Noodles/ ");
            arr2.remove(49.99);
        }

        if(c5.isChecked())
        {
            arr.add("Seafood Chinese Noodles / ");
            arr2.add(79.99);
        }else
        {
            arr.remove("Seafood Chinese Noodles / ");
            arr2.remove(79.99);
